...
class AppColors {
  ...
  static const baseBlackColor = Color(0xff1b1d1b);
  static const baseGrey90Color = Color(0xff2d2f2f);
  static const baseGrey80Color = Color(0xff3c3c3e);
  static const baseGrey70Color = Color(0xff545455);
  static const baseGrey60Color = Color(0xff6d6e71);
  static const baseGrey50Color = Color(0xff8d8d8e);
  static const baseGrey40Color = Color(0xffbababa);
  static const baseGrey30Color = Color(0xffdadada);
  static const baseGrey20Color = Color(0xffeaeaea);
